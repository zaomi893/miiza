...
- `fastbuild_6.12.38_oneplus_15t.yml`：一加 15T 专用 6.12.38 快速构建。源码使用 `zaomi893/android_kernel_common_oneplus_sm8850` 的 `oneplus/sm8850_b_16.0_oneplus_15t` 分支，固定提交以已验证可启动的 `150cab866c...` 为父提交，并内置可选的 TCP Brutal、ADIOS、Re-Kernel 源码；版本号为 `android16-5-g844001fb8721-ab14552068-4k`，工具链为 Clang `r547379` / Rust 1.82，继续固定 `CONFIG_LTO_NONE=y`。
